let passPhrases = `pphsv ojtou brvhsj cer ntfhlra udeh ccgtyzc zoyzmh jum lugbnk
...
let phrasesArray = passPhrases.split("\n");
...
for (let i = 0; i < phrasesArray.length; i++) {
    const line = phrasesArray[i];
    if (lineReader(line) == true) {
        validPhrases++;
    }
}

console.log("Total # of phrases: " + phrasesArray.length);
